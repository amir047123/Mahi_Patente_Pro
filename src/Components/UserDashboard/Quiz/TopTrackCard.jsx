import user from "@/assets/UserDashboard/demo-user.svg";
    ...
    return (
      <div className="flex gap-5 items-center bg-white rounded-lg overflow-hidden">
        <div className="p-3 relative">
          ...
          <span className="bg-blue-600 text-white text-[12px] px-1.5 rounded-full absolute bottom-1 right-[40%]">1</span>
        </div>
