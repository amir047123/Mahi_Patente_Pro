...
const SenderChat = ({ message }) => {
  ...
  return (
    <div className="flex items-start gap-3 max-w-md justify-end ml-auto mb-5">
      <div>
        ...
        <div className=" bg-gradient-to-r from-[#4B2BB2] to-[#B262B2] text-[13px] max-w-[250px] 2xl:max-w-[350px] p-3 rounded-l-2xl rounded-b-2xl text-white">
          {message?.file && (
            <img
              src={message?.file}
              alt="file"
