          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-5">
                <a href="https://play.google.com/store/apps/details?id=com.mahipatentepro" target="_blank">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/share/16cAsnPE7H/?mibextid=wwXIfr"
                  target="_blank"
                ...
                <a
                  href="https://youtube.com/@insegnantemahi?si=v-_nRSvEjtcN0g1t"
                  target="_blank"
                  className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-300 text-gray-600 hover:bg-gray-50"
                >
                  <svg
                ...
                <a
                  href="https://www.instagram.com/insegnante_mahi?igsh=NzZ1OWtsdXRuZjI1"
                  target="_blank"
                  className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-300 text-gray-600 hover:bg-gray-50"
                >
                  <svg
