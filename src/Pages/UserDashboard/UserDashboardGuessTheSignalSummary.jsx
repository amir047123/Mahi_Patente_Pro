...
const UserDashboardGuessTheSignalSummary = ({
  isSummary,
  setIsSummary,
  quizzes,
  time,
            ...
            <table className="w-full border-collapse">
              <thead className="sticky top-0">
                <tr className="bg-gray-100">
                  ...
                  <th className="p-1 px-2 border border-gray-300 text-left text-secondaryText  font-normal">
                    <Typography.Body>Guess the sign depicted</Typography.Body>
                  </th>
                </tr>
              </thead>
                ...
                {quizzes &&
                  ...
                  quizzes?.map((quiz, index) => (
                    ...
                    >
                      ...
                      <td className="p-4 border border-gray-300 w-28 text-center">
                        <div className={`p-2 rounded-lg w-20 bg-white`}>
                          <img
...
export default UserDashboardGuessTheSignalSummary;
