...
const AdminDashboardGuessTheSignalQuestions = () => {
  ...
  const {
    ...
    isError,
    isLoading,
  } = useFetchEntities({ category: "Guess the Signal" });
    ...
    <>
      ...
      <FilterComponent
        ...
        fields={[
          ...
          {
            type: "link",
            name: "Add Guess The Signal Question",
            path: "/admin-dashboard/quiz-manage/guess-the-signal/add-guess-the-signal",
          },
        ]}
      />
              ...
              response?.data?.questions?.map((quiz, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="py-4 px-4 text-sm text-green-600 ">
                    {quiz?.options[parseInt(quiz?.correctAnswer)]}
                  </td>
